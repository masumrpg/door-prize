...
export default function PrizeEdit({ prize }: Props) {
  ...
  return (
      <AppLayout breadcrumbs={breadcrumbs}>
          <Head title={`Edit Hadiah: ${prize.name}`} />
          <div className="p-4">
              <div className="flex items-center mb-6">
                  ...
                  <h1 className="text-2xl font-bold">Edit Hadiah</h1>
              </div>
                      ...
                      <CardContent className="space-y-6">
                          ...
                          <div className="space-y-2">
                              ...
                              <p className="text-sm text-gray-500">
                                  Jumlah total hadiah ini yang tersedia untuk pemenang.
                                  {prize.remaining_stock > 0 && (
                                      <span className="text-amber-600"> Nilai minimum: {prize.remaining_stock} (tersisa saat ini)</span>
                                  )}
                              </p>
                          </div>
                              ...
                              <div className="flex items-center gap-4">
                                  ...
                                  <div className="flex-1">
                                      ...
                                      <p className="text-sm text-gray-500 mt-1">
                                          Unggah gambar baru untuk mengganti gambar saat ini. Ukuran yang disarankan: 500x500px.
                                      </p>
                                      {imagePreview && (
                                          <Button
                                              type="button"
                          ...
                          <div className="space-y-2">
                              ...
                              <p className="text-sm text-gray-500">
                                  Hadiah yang aktif akan tersedia untuk dipilih selama acara doorprize.
                              </p>
                          </div>
                          ...
                          {prize.remaining_stock < prize.total_stock && (
                              <div className="p-4 bg-amber-50 rounded-md">
                                  <p className="text-amber-800 text-sm">
                                      <strong>Catatan:</strong> Hadiah ini telah diberikan kepada {prize.total_stock - prize.remaining_stock} pemenang.
                                      Beberapa perubahan mungkin mempengaruhi data historis.
                                  </p>
                              </div>
                          )}
                      </CardContent>
